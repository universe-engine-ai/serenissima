...
def create_or_update_public_sell_contract_from_decision(
    ...
    try:
        ...
        if existing_contract_record:
            ...
            update_fields = {
                "TargetAmount": target_amount, # Changed from 0.0 as per request
            ...
            print(f"Updated public sell contract {custom_contract_id} for {resource_type} from building {building_id}: Airtable.TargetAmount={target_amount}, Price={price_per_resource}")
        else:
            ...
            print(f"Created new public sell contract {custom_contract_id} for {resource_type} (Name: {resource_name}) from building {building_id}: Airtable.TargetAmount={target_amount}, Price={price_per_resource}")
        return True
    except Exception as e:
