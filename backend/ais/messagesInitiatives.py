...
def generate_ai_initiative_message(tables: Dict[str, Table], ai_username: str, target_username: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            f"You are {ai_display_name}, a citizen of Venice. You're about to send a quick message to {target_display_name}. "
            f"Keep it super short, natural, and like you're chatting with someone you know. No fancy words, no long speeches, just get straight to the point. "
            f"Make sure it's relevant to what's happening in the game and your connection with {target_display_name}, using the info I've given you.\n\n"
            f"Here's some background info to help you craft your message (this is in the 'addSystem' field):\n"
            ...
            f"What's your message to {target_display_name}?"
        )
