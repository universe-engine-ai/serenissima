...
def generate_ai_initiative_message(tables: Dict[str, Table], ai_username: str, target_username: str, kinos_model_override: Optional[str] = None) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"IMPORTANT: Your message must be concise and conversational, acting as a natural conversation starter. DO NOT mention that you 'decided to send a message' or that this is an 'initiative'. Just start talking naturally. Ensure your language is appropriate to your social class and background, reflecting your persona's communication style. Be direct and avoid unnecessary fluff.\n\n"
            ...
            f"Remember: CONCISE, conversational, RELEVANT, FOCUSED ON GAMEPLAY. Start naturally.\n"
            f"Your message:"
        )
