...
def generate_ai_initiative_message(tables: Dict[str, Table], ai_username: str, target_username: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Specifically, consider any *active problems* you or {target_display_name} are facing, and how your relationship or a shared interest could offer a solution or opportunity for mutual benefit or strategic advancement.\n\n"
