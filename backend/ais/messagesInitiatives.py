...
def generate_ai_initiative_message(tables: Dict[str, Table], ai_username: str, target_username: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"- Consider if discussing a specific stratagem (e.g., 'Coordinate Pricing', 'Undercut') would be a relevant and beneficial topic for this conversation, especially if it aligns with recent problems or opportunities.\n\n"
