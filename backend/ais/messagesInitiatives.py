...
def generate_ai_initiative_message(tables: Dict[str, Table], ai_username: str, target_username: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Your message should reflect your understanding of your relationship, recent events, and how this interaction can strategically advance your position or goals in Venice, aligning with your persona's traits.\n\n"
