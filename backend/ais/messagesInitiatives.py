...
def generate_ai_initiative_message(tables: Dict[str, Table], ai_username: str, target_username: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"- 'relationship_with_target': Your relationship with {target_display_name}.\n"
            f"- 'recent_notifications_for_ai': Recent news/events you've seen.\n"
            f"- 'recent_relevancies_ai_to_target': Why {target_display_name} is relevant to you.\n"
            f"- 'recent_problems_involving_ai_or_target': Recent issues for you or {target_display_name}.\n\n"
            f"What's your message to {target_display_name}? Start naturally:\n"
        )
