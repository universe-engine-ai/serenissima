...
def generate_ai_initiative_message(tables: Dict[str, Table], ai_username: str, target_username: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"To make the greeting casual and direct, start with a simple, friendly opening. "
            f"For example, 'Hey [Name]', 'Good day, [Name]', or a direct address like '[Name], I was thinking...'\n\n"
