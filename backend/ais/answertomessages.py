...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Avoid overly formal words like 'Indeed', 'Furthermore', 'Moreover', 'However'. Start with a very casual greeting (e.g., 'Hey', 'Hi') or, preferably, dive straight into the topic without a formal salutation.\n\n"
            ...
            f"- 'recent_relevancies_ai_to_sender': Why {sender_display_name} is specifically relevant to you. This is key for a relevant response!\n"
