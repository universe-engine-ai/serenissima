...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Your response must be very short, human-like, and conversational. Be direct, natural, and concise, like a quick, informal message. "
            f"Avoid formal language, long paragraphs, or boilerplate. ALWAYS start with a casual greeting. "
            f"Examples: 'Hey {sender_display_name},', 'Hi {sender_display_name},', 'Good to hear from you, {sender_display_name}.', or 'What's new, {sender_display_name}?'\n\n"
