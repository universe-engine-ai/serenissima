...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Be direct, natural, and concise. Imagine you're sending a quick, informal message. ALWAYS start your message with a casual greeting like 'Hey {sender_display_name},', 'Hi {sender_display_name},', 'Good to hear from you, {sender_display_name}.', or 'What's new, {sender_display_name}?'\n\n"
