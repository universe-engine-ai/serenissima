...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Your message should reflect your understanding of your relationship, recent events, and potential gameplay interactions with {sender_display_name}. Crucially, aim to strategically advance your position or goals in Venice through this interaction.\n\n"
