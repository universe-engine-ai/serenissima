...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"CRITICAL: Leverage the structured context provided in the 'addSystem' field (detailed below) to craft a response that is not only RELEVANT to {sender_display_name} but also strategically advances your position or goals in Venice. Your message should subtly reflect your understanding of your relationship, recent events (like their recent land purchase), and potential future gameplay interactions with {sender_display_name}.\n\n"
