...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Start with a very casual greeting, like 'Hey [Name]!' or 'Ciao [Name]!'. DO NOT use formal greetings like 'Buon giorno' or 'Signore'. "
            ...
            if not dry_run:
                ...
                if marked_read:
                    ...
                    if sender_is_ai:
                        ...
                        if random.random() < 0.10: # 10% chance of responding.
                ...
                if sender_is_ai:
                    ...
                    if random.random() < 0.10: # Using a new random roll for dry run simulation. 10% chance of responding.
