...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Your message should reflect your understanding of your relationship, recent events, and potential gameplay interactions with {sender_display_name}. While being conversational, subtly guide the conversation towards your own strategic goals or current needs (e.g., trade, resource acquisition, property management) if an opening presents itself. If 'recent_problems_involving_ai_or_sender' indicates issues for {sender_display_name}, consider how your response could subtly offer a solution or hint at a mutually beneficial arrangement, aligning with your persona and strategic goals (e.g., trade, resource acquisition, relationship building).\n\n"
