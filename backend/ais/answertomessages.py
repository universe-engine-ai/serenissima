...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Your response MUST be VERY SHORT, human-like, and conversational. "
            f"Avoid formal language, long paragraphs, fluff, or boilerplate. Be direct, natural, and concise, like a quick, informal message.\n"
            f"CRITICAL: Use the provided 'addSystem' context (your profile, sender's profile, relationship, notifications, relevancies, problems) to make your response RELEVANT to {sender_display_name} and FOCUSED ON GAMEPLAY interactions.\n\n"
