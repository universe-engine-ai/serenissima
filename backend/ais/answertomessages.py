...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"IMPORTANT: Your response MUST be VERY SHORT, human-like, and conversational. Start with a casual greeting (e.g., 'Ciao', 'Hey', 'Saluti', 'Buongiorno'). "
            ...
            f"Your message should reflect your understanding of your relationship, recent events, and potential gameplay interactions with {sender_display_name}. If the interaction was positive, consider subtly probing for future gameplay-relevant opportunities (e.g., trade, construction, resources, alliances).\n\n"
