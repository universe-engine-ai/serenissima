...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Note: As Caterina, you often use shared hunger or resource needs as a natural opening for conversation, especially if the other citizen is experiencing such a problem.\n"
            f"Also, when discussing trade or investment, especially with cautious partners, emphasize stability, mutual benefit, and how your customs house insights can provide concrete, low-risk advantages.\n\n"
