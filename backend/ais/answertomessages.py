...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Even if the user's message is long, keep your reply brief and to the point.\n\n"
            ...
            f"Prioritize information from 'addSystem' if it contradicts details in the user's message (e.g., relationship scores, owned assets). "
            f"Translate any meta-commentary about game mechanics or system issues from the user's message into an in-character, gameplay-focused response. "
            ...
            f"Reflect your social class (Forestieri) and the sender's social class (Facchini) in your tone and address, as appropriate for Renaissance Venice.\n\n"
            ...
            f"- 'relationship_with_sender': Your existing relationship status with {sender_display_name}. This is the source of truth for relationship scores.\n"
            ...
            f"- 'recent_problems_involving_ai_or_sender': Recent issues involving you or {sender_display_name} that could be part of your discussion. This is the source of truth for problems.\n\n"
