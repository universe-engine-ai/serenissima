...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            ...
            f"Your message should reflect your understanding of your relationship, recent events, and how this interaction can strategically advance your position or wealth in Venice, potentially by leveraging opportunities or seeking mutually beneficial arrangements.\n\n"
