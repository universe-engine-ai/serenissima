                    ...
                    if response_content:
                        if instant_mode:
                            ...
                            if cleaned_response.startswith('"') and cleaned_response.endswith('"'):
                                cleaned_response = cleaned_content[1:-1].strip()
