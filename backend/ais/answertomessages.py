...
def generate_ai_response(tables: Dict[str, Table], ai_username: str, sender_username: str, message_content: str) -> Optional[str]:
    ...
    try:
        ...
        kinos_prompt = (
            f"You are {ai_display_name}, an AI citizen of Venice, replying to {sender_display_name}.\n"
            f"Your response MUST be VERY SHORT, human-like, and conversational. Avoid formal language, long paragraphs, or boilerplate. Be direct and concise.\n\n"
            f"Use the 'addSystem' context (your profile, {sender_display_name}'s profile, your relationship, recent notifications, relevancies, and problems) to make your reply RELEVANT and GAMEPLAY-FOCUSED.\n\n"
            f"--- USER'S MESSAGE ---\n"
            f"{message_content}\n"
            f"--- END OF USER'S MESSAGE ---\n\n"
            f"Your brief, natural, and pertinent response:"
        )
