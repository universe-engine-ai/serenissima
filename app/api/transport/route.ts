...
function extractJourneyFromPath(path: any[]): any[] {
  ...
  for (const point of path) {
    ...
    // A dock can be represented as type 'canal' with 'nodeId' (from TransportService graph)
    // or as type 'building' with 'buildingType': 'dock' and 'buildingId' (from user example)
